...
// UAModalPanel
#define COCOAPODS_POD_AVAILABLE_UAModalPanel
#define COCOAPODS_VERSION_MAJOR_UAModalPanel 1
#define COCOAPODS_VERSION_MINOR_UAModalPanel 1
#define COCOAPODS_VERSION_PATCH_UAModalPanel 1
