...
//------------------------------------------------------------------------------------------------------------------------------
{
    ...
    UITableView *tableViewSignup = [[UITableView alloc] initWithFrame:CGRectMake(5.0f, 0, WINSIZE.width - 10.0f, 3 * kTableViewCellHeight)];
...
//------------------------------------------------------------------------------------------------------------------------------
{
    ...
    UITableView *tableViewLogin = [[UITableView alloc] initWithFrame:CGRectMake(5.0f, 0, WINSIZE.width - 10.0f, 2 * kTableViewCellHeight)];
